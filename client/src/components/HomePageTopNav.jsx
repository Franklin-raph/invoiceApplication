...
const HomePageTopNav = ({ billData }) => {
    ...
    return (
        <div className="text-white w-[100%] lg:w-[85%] ml-0 lg:ml-[10rem] px-[1rem] lg:px-[4rem] mt-[8rem] lg:mt-[4rem] mb-10">
            ...
            {loggedInVendor &&
                <div className='flex items-center justify-between mb-3'>
                    <p className='flex items-center gap-3'>Welcome, <span className='font-bold'>{loggedInVendor.fName} {loggedInVendor.lName}</span>
                    ...
                    {loggedInVendor.profilePic ?
                        <div className='flex items-center w-[5%]'>
                            <img className='rounded-full w-[100%]' src={loggedInVendor.profilePic} alt="" />
                            <i className="ri-arrow-down-s-fill lg:hidden"></i>
                        </div>
                        :
                        <div className='flex items-center w-[5%]'>
