...
const VendorSettings = () => {
    ...
    return (
        <div className="md:px-[100px] px-5 mx-auto w-full md:w-[90%] md:mt-2 mt-[6rem] md:mb-2 mb-[10rem]">
            ...
            <div className="text-white mt-5 flex mb-5 w-full md:w-[80%] mx-auto justify-start gap-[3rem] bg-[#1F213A] p-4 rounded-md relative">
            ...
            {isEdit ?
                ...
                :
                <div className="text-white w-full md:w-[80%] mx-auto justify-between gap-[5rem] bg-[#1F213A] p-8 rounded-md mb-10">
